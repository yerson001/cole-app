...
class DirectorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Director', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text('Director', style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
