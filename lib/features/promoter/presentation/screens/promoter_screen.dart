...
class _PromoterScreenState extends State<PromoterScreen> {
  final List<Widget> pageList = <Widget>[
    ...
    const _PlaceholderPage(icon: Icons.campaign, label: 'Promociones'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<PromoterBloc, PromoterState>(
        builder: (context, state) {
          return pageList[state.pageIndex];
        },
      ),
      drawer: BlocBuilder<PromoterBloc, PromoterState>(
        builder: (context, state) {
          return Drawer(
            child: ListView(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () {
                          context.read<PromoterBloc>().add(ChangeDrawerPage(pageIndex: 0));
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          context.read<PromoterBloc>().add(ChangeDrawerPage(pageIndex: 1));
                          Navigator.pop(context);
                        },
                      ),
                      ListTile(
                        ...
                        onTap: () {
                          context.read<PromoterBloc>().add(ChangeDrawerPage(pageIndex: 2));
                          Navigator.pop(context);
                        },
                      ),
                    ],
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () {
                          context.read<PromoterBloc>().add(ChangeDrawerPage(pageIndex: 3));
                          Navigator.pop(context);
                        },
                      ),
                      ListTile(
