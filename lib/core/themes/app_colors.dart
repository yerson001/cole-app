...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const light = AppColors(
    ...
    primaryDark: Color(0xFF070F19),
    primaryLight: Color(0xFF1B3A5C),
    ...
    bottomNavActive: Color(0xFF0D1B2A),
  ...
  static const dark = AppColors(
    ...
    buttonPrimary: Color(0xFF90CAF9),
    buttonPrimaryText: Color(0xFF121212),
    buttonSecondary: Color(0xFF424242),
    buttonSecondaryText: Color(0xFFE0E0E0),
    buttonDisabled: Color(0xFF616161),
    buttonDisabledText: Color(0xFF424242),
    icon: Color(0xFF9E9E9E),
    iconActive: Color(0xFFE0E0E0),
    inputBackground: Color(0xFF2C2C2C),
    inputBorder: Color(0xFF616161),
    inputFocused: Color(0xFF90CAF9),
    ...
    bottomNavActive: Color(0xFF90CAF9),
    overlay: Color(0xB3000000),
    shimmer: Color(0xFF424242),
  );
